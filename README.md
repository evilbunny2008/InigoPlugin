...
### For metric
```
wget https://github.com/evilbunny2008/InigoPlugin/releases/download/1.0.7/inigo-metric.tar.gz
```
...
```
wget https://github.com/evilbunny2008/InigoPlugin/releases/download/1.0.7/inigo-imperial.tar.gz
```
