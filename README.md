...
One way to reliably detect peak daily temperature in real time is by using [a z-score algorithm](https://stackoverflow.com/questions/22583391/peak-signal-detection-in-realtime-timeseries-data/56451135#56451135) and to supply temperature data from loop packets to the algorithm.
